const OmniTrend = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" {...props}>
        ...
        />
        <defs>
            <linearGradient id="a" x1={21.646} x2={9.226} y1={8.042} y2={29.405} gradientUnits="userSpaceOnUse">
                <stop stopColor="#0073D4" />
                <stop offset={0.3} stopColor="#1D9EFF" />
                <stop offset={0.7} stopColor="#995CFF" />
            </linearGradient>
            <linearGradient id="b" x1={18.281} x2={6.15} y1={3.059} y2={24.071} gradientUnits="userSpaceOnUse">
