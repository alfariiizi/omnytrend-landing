        ...
        <section id="features" className="relative scroll-mt-[10vh] px-6 py-24">
            <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-2">
                ...
                <div className="glass-card group relative overflow-hidden rounded-2xl p-4 transition-all hover:-translate-y-2 lg:p-10">
                    ...
                    <h3 className="mb-3 text-2xl font-bold text-white">Analisis Data Ecommerce</h3>
                    <p className="mb-8 max-w-sm text-base leading-relaxed text-gray-400">
                        Sistem chat dengan AI yang responsif untuk analisis data secara real-time dan akurat. Cukup ketik pertanyaanmu.
                    </p>
                    ...
                    <div className="group-hover:border-brand/30 relative h-64 overflow-hidden rounded-xl border-2 border-white/10 bg-[#0B1120] p-4 transition-colors">
                        <div className="space-y-4">
                            <div className="animate-slide-in-left flex items-start gap-3">
                                <div className="bg-brand/20 text-brand flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-xs font-bold">U</div>
                                <div className="rounded-2xl rounded-tl-none bg-white/5 p-3 text-sm text-gray-300">Carikan tren sunscreen bulan ini.</div>
                            </div>
                            <div className="animate-slide-in-right flex flex-row-reverse items-start gap-3" style={{ animationDelay: "0.5s" }}>
                                ...
                                <div className="bg-brand/10 border-brand/20 rounded-2xl rounded-tr-none border p-3 text-sm text-gray-300">
                                    <span className="text-brand-teal mb-1 block font-semibold">Trending Naik 15% 📈</span>
                                    Produk sunscreen tipe gel sedang diminati di Shopee dengan volume pencarian meningkat tajam di area Jabodetabek.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="glass-card group relative overflow-hidden rounded-2xl p-4 transition-all hover:-translate-y-2 lg:p-10">
                    ...
                    <h3 className="mb-3 text-2xl font-bold text-white">Data Produk Lengkap</h3>
                    <p className="mb-8 max-w-sm text-base leading-relaxed text-gray-400">
                        Informasi produk real-time secara lengkap, mulai dari harga, stok, hingga sentimen ulasan pembeli.
                    </p>
                        ...
                        {[1, 2].map(i => (
                            <div
                                ...
                                <div className="mt-2 flex items-center justify-between">
                                    <div className={`h-2 w-1/3 rounded ${i === 1 ? "bg-brand-teal" : "bg-brand-purple"}`}></div>
